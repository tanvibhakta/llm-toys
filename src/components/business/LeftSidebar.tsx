...
export default function LeftSidebar() {
  return (
    <aside className="h-14 tablet:h-auto w-full min-w-17 sticky bottom-0 tablet:w-64 tablet:max-w-64 bg-red-900/50 border-r border-gray-800 p-4 flex flex-col justify-between">
